/**    
* @Title: CronExpParser.java  
* @Package cn.ctx.admin.core.quartz  
* @Description: TODO(用一句话描述该文件做什么)  
* @author gyu
* @date 2017年11月14日 下午2:01:15  
* @version V1.0    
*/
...
public class CronExpParser
{
     ...
     */
    public static boolean parser(String cronExpression, String cronDate, List<String> result) throws java.text.ParseException
    {
    ...
    public static String translateToChinese(String cronExp) throws java.text.ParseException
    {
    ...
    {
        String CRON_EXPRESSION = "0 15 10 ? * 1";
        // 生成指定日期的CRON时间序列
