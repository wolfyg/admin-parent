...
public class WebUtils {
	...
	public static HashMap<String, String> getPraramsAsMap(HttpServletRequest request) {
		...
		if(org.apache.commons.lang3.StringUtils.isNotEmpty(hashMap.get("iDisplayStart"))){
			int start=1;
//			if(MethodUtil.isNumeric(hashMap.get("iDisplayStart"))){
//				start=Integer.parseInt(hashMap.get("iDisplayStart"));
//			}
...
//		if(StringUtils.isNotEmpty((String) hashMap.get("currentPage"))){
//			int start=1;
//			if(StringUtils.isNotEmpty((String) hashMap.get("currentPage"))){
//				//当前页数
//				start=Integer.parseInt((String) hashMap.get("currentPage"));
//			}
//			//每页显示多少条
//			int end=Integer.parseInt((String) hashMap.get("pageSize"));
